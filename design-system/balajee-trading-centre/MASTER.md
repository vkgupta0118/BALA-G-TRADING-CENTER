...
**Project:** Balajee Trading Centre
**Generated:** 2026-09-20 16:38:47
...
The palette, pattern and density above were adopted as generated. Two recommendations were
replaced after checking fit for a building-materials shop – see `docs/design-decisions.md`:

- **Style:** "Liquid Glass" → flat, solid surfaces with restrained card shadows (skill result `flat-design`).
- **Typography:** Cormorant + Montserrat → **Bebas Neue** (display) + **Source Sans 3** (body) + **Noto Sans Bengali**
  (skill result *Bold Statement*; Bengali face added for the language toggle).
- **Extra tokens:** steel-blue `#2B5B84` (links/focus), gold-400 `#E3B341` (highlights on dark), WhatsApp `#0E7566`.

Tokens live in `src/styles/tokens.css`. Contrast audit and rationale: `docs/design-decisions.md`.
